package com.divyanshi.garg.calculator;
    ...
    public class converting_units {
        ...
        static class Volume {
            public double cuMilliToMeter(double milli) {
                return (milli / 1000000000);
            }

            public double cuMeterToMilli(double meter) {
                return (meter * 1000000000);
            }

            public double cuCentiToMeter(double Centi) {
                return (Centi / 10000000);
            }

            public double cuMeterToCenti(double meter) {
                return (meter * 10000000);
            }

            public double cuKiloToMeter(double Kilo) {
                return (Kilo * 1000000000);
            }

            public double cuMeterToKilo(double meter) {
                return (meter / 1000000000);
            }
        ...
        public static class Currency {
            ...
            public double DollarToEuros(double Dollar) {
                return (Dollar / 0.89);
            }
            ...
            public double RupeetoEuros(double Rupee) {

                return (Rupee / 78.40);
            }


            public double EurosToRupee(double Euros) {
                return (Euros * 78.40);
