...
public class Currency extends AppCompatActivity {
    ...
    private converting_units.Currency ca;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ca = new converting_units.Currency();
    ...
    public double evaluate(int item1, int item2, double value) {
        ...
        if (item1 == item2)
            ...
            switch (item1) {
                ...
                case 1:
                    temp = ca.EurosToRupee(value);
                    break;
                case 2:

                    temp = ca.DollarToRupee(value);
            ...
            switch (item2) {
                case 0:
                    ...
                    break;
                case 1:
                    temp = ca.RupeetoEuros(temp);
                    break;
                case 2:
                    temp = ca.RupeeToDollar(value);
