...
public class Volume extends AppCompatActivity {
    ...
    private converting_units.Volume ca;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ca=new converting_units.Volume();
...
// Apply the adapter to the spinner
    ...
    public double evaluate(int item1,int item2,double value){
        ...
        else
        {
            ...
            {
                case 0:
                    temp=ca.cuMilliToMeter(value);
                    break;
                case 1:
                    temp=ca.cuCentiToMeter(value);
                    break;
                case 2:
            ...
            {
                case 0:
                    temp=ca.cuMeterToMilli(temp);
                    break;
                case 1:
                    temp=ca.cuMeterToCenti(temp);
                    break;
                case 2:
                    temp=value;
                    break;
                case 3:
                    temp=ca.cuMeterToKilo(temp);
                    break;
            }
            return temp;
        }
